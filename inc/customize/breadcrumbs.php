...
class Kama_Breadcrumbs {
	...
	function get_crumbs( $sep, $l10n, $args ) {
		...
		if ( 1 ) {
			...
			if ( ! $mark ) {
				$mark = array(
					'wrappatt'  => '<div class="kama_breadcrumbs"><div class="container">%s</div>></div>',
			...
			elseif ( $mark === 'rdf.data-vocabulary.org' ) {
				$mark = array(
					'wrappatt'  => '<div class="kama_breadcrumbs" prefix="v: http://rdf.data-vocabulary.org/#"><div class="container">%s</div></div>',
			...
			elseif ( $mark === 'schema.org' ) {
				$mark = array(
					'wrappatt'  => '<div class="kama_breadcrumbs" itemscope itemtype="http://schema.org/BreadcrumbList"><div class="container">%s</div></div>',

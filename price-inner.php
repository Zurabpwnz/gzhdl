<?php
/**
 * Template Name: Стоимость перевозок дочерняя
 *
...
<?php if ( function_exists( 'kama_breadcrumbs' ) ) {
    ...
    <section class="banner"
             style="background-image: url('<?php the_field( 'stoimost_perevozok_-_dochernyaya_-_banner_-_izobrazhenie' ); ?>')">
        <div class="container">
            <div class="row">
                <div class="col">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
					...
					<?php get_field( 'stoimost_perevozok_-_dochernyaya_-_tip_perevozki' ) ?>


					<?php if ( have_rows( 'stoimost_perevozok_-_dochernyaya_-_tip_perevozki' ) ) : ?>

                        <nav class="tariffs-nav">
                            <p>Тип перевозки:</p>

							<?php while ( have_rows( 'stoimost_perevozok_-_dochernyaya_-_tip_perevozki' ) ) : the_row(); ?>
            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    <div class="content__text">
						<?php the_field( 'stoimost_perevozok_-_dochernyaya_-_kontent_levaya' ); ?>
                    </div>
                </div>
                <div class="col-12 col-lg-6">
                    <div class="content__text">
						<?php the_field( 'stoimost_perevozok_-_dochernyaya_-_kontent_pravaya' ); ?>
                    </div>
                </div>
            </div>
        </div>
...
<?php if ( have_rows( 'stoimost_perevozok_-_dochernyaya_-_drugie_uslugi' ) ) : ?>
                ...
                <div class="tags-slider">
                    <div class="swiper-tags">
                        <div class="swiper-wrapper">
							...
							<?php while ( have_rows( 'stoimost_perevozok_-_dochernyaya_-_drugie_uslugi' ) ) : the_row(); ?>

                                <div class="swiper-slide tags-slide">
                                    <a href="<?php the_sub_field( 'ssylka' ); ?>"
                                       class="btn btn-white tags__btn"><?php the_sub_field( 'nazvanie' ); ?></a>
                                </div>
...
<?php $stoimost_perevozok_dochernyaya_chasto_zadavaemye_voprosy = get_field( 'stoimost_perevozok_-_dochernyaya_-_chasto_zadavaemye_voprosy' ); ?>
<?php if ( $stoimost_perevozok_dochernyaya_chasto_zadavaemye_voprosy ) : ?>
    ...
    <section class="faq">
        <div class="container">
            <div class="row">
	            ...
	            <?php foreach ( $stoimost_perevozok_dochernyaya_chasto_zadavaemye_voprosy as $post ) : ?>
